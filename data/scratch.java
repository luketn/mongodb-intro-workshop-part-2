...
class Scratch {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException, InterruptedException {
        ...
        for (List<String> row : csvFile.lines) {
            ...
            Fruit fruit = new Fruit(name, description, priceDecimal.doubleValue(), Integer.parseInt(quantity));
            fruits.add(fruit);
        }
    ...
    public record Fruit (String name, String description, double price, int quantity) {}
